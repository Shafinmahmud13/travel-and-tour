...
#--------------Bud urls______
    ...
    path('bus/<id>/orderBus', views.orderBus, name='orderBus'),
    path('myBusOrders', views.myBusOrders, name='myBusOrders'),
    path('bus/<id>/orderBusDelete', views.orderBusDelete, name='orderBusDelete'),
    path('bus/<int:id>/', views.bus_view, name='bus_view'),
